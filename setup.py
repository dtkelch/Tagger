...
#
#     from twittergram import metadata
#
# However, when we do this, we also import `twittergram/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'twittergram_cli = twittergram.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'twittergram_gui = twittergram.gui:entry_point'
        # ]
    }
)
